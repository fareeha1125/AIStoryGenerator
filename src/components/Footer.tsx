...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchStarCount = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/0xmetaschool/StoryGeneratorGPT');
  ...
  return (
    <footer className="mt-188px w-full bg-[#2C3440]">
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="flex justify-between items-start">
          {/* Left side */}
          <div>
            <div className="text-gray-400 text-xs mb-4 pt-1 pb-1 pl-3 pr-3 bg-[#3A4553] max-w-[190px] rounded-md">
              Free Open source AI template
            </div>
            <div className="text-white mb-4 text-2xl font-bold font-sans">
              Build your own Story Generator GPT
            </div>
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center gap-3 pt-4 text-gray-400 hover:text-white">
